...
import os
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'colibri_django_rest_framework.settings')
...
def main() :
    ...
    with open('Pandas test large data set\MOCK_DATA.json', 'r') as json_file :
        ...
        for key, val in data_dict['id'].items() :
            ...
            print(f"id = {id}, first_name= {first_name}, last_name= {last_name}, g={gender}, salary={salary}, years={years_of_experience}   {type(years_of_experience)}" )
